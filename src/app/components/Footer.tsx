        ...
        <div className="flex flex-col md:flex-row justify-between gap-6 md:gap-8 items-start w-full">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto md:max-w-lg">
            <input
              ...
              className="w-full md:w-[400px] px-4 py-3 rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm md:text-base"
            />
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-1 text-center md:text-left">
            ...
            <ul className="space-y-3 ">
              ...
              <li>
                <div className="flex flex-wrap gap-4 lg:items-start mt-10 justify-start">
                  {/* Social Icons */}
                  ...
                  <a href="#" className="text-gray-400 hover:text-white transition-colors">
                    <img src="/assets/image/footer/4.svg" alt="medium"/>
                    </a>
                  <a href="#" className="text-gray-400 hover:text-white transition-colors">
                    <img src="/assets/image/footer/5.svg" alt="medium"/>
                    </a>
