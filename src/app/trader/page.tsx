...
const TraderPage = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-[#050026] to-[#110942] text-white" style={{fontFamily: 'lato, sans-serif'}}>
      {/* Hero Section */}
      <section className="w-full px-5 md:px-20 py-10 md:py-20 relative">
        <div className="flex flex-col lg:flex-row items-center gap-10 w-full">
          ...
          <div className="lg:w-3/5">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-[64px] font-bold leading-tight mb-6" style={{ fontFamily: 'lato, sans-serif' }}>Simplify Your Crypto Journey</h1>
          ...
          <div className="lg:w-2/5 flex justify-center relative">
            <div className="relative w-80 h-80 md:w-full md:h-full">
              ...
              <img alt="Blockchain 3D Cube Visualization" width={525} height={430} className="relative z-10" src="/assets/image/trader_1.svg" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section
        className="w-full py-10 md:py-20 relative flex flex-col items-center justify-center bg-[#110942] px-5 md:px-20"
        style={{
