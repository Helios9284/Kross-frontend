    ...
    <div className="min-h-screen w-full bg-gradient-to-b from-[#050026] to-[#110942] text-white font-sans">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex gap-12">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-8 group-hover:stroke-[#A020F0] transition">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 group-hover:stroke-[#A020F0] transition">
      ...
      <section className="py-20 bg-gradient-to-br from-[#0a0a2f] via-[#1a0a3f] to-[#2a0a4f] text-white relative overflow-hidden">
        <div className=" mx-auto px-5 md:px-20 relative">
          ...
          <div className="relative">
            ...
            <p className="text-start text-white text-[20px] px-4 py-10">
            <img alt="Mask Gruop" className="relative" src="/assets/image/landing/Mask_group.svg" />
